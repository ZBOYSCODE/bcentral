...
class ComercioController extends ControllerBase
{
    ...
    legend: {
		...
		echo $this->view->render('theme',array('lmView'=>'menu/leftMenu','pcView'=>'solicitudes/dashboard','pcData'=>'', 'jsScript'=>$jsScript));
    }

    public function consultarAction()
    {
    	echo $this->view->render('theme', array('lmView'=>'menu/leftMenu', 'pcView'=>'solicitudes/consultaSolicitud', 'pcData'=>''));    
    }
    ...
    public function evaluarAction()
    {
        ...
        echo $this->view->render('theme', array('lmView'=>'menu/leftMenu', 'pcView'=>'solicitudes/evaluarSolicitud', 'pcData'=>'', 'jsScript'=>$jsScript));    
    }
